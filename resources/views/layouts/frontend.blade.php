        ...
        <nav class="nav-menuzord navbar-sticky">
            <div class="container clearfix">
                <div id="menuzord" class="menuzord menuzord-responsive">
                    ...
                    <a href="/home" class="menuzord-brand">
                    ...
                    <div class="float-right btn-wrapper">
                        @if(Auth::check())
                            <a class="btn btn-outline-primary" href="/backHome"> <span>登录控制台</span></a>
                        @endif
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-7 col-xs-12">
                ...
                <p class="text-muted pt-1 pb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
